...
NAMES.OE_FROZEN_TOOL_SHOVEL = "Chilled Shovel"
NAMES.OE_FROZEN_TOOL_HAMMER = "Frozen Mallet"
NAMES.OE_FROZEN_SWORD = "Frostbane"
...
NAMES.OE_TRINKETS_SNOWGLOBE = "Snowglobe"