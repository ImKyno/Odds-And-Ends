--[[-------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    * After that, simply copy the three original files "oe_strings.lua", "oe_strings_loadingtips.lua" and "oe_strings_scrapbook.lua"
    ...
    * ALL STRINGS of "scripts/strings/oe_strings.lua" can be translated.
    * ALL STRINGS of "scripts/strings/oe_strings_scrapbook.lua" can be translated.
    * ALL STRINGS of "scripts/strings/oe_strings_worldsettings.lua" can be transled.

    * DO NOT COPY "scripts/strings/oe_strings_worldsettings.lua" TO YOUR LOCALIZATION FORLDER! More deails can be found there.
    ...
    * Some strings may have \"Text\" that means that text has quotation marks.
    ...
    exclusive to talk about translations #translations. Otherwise you can also send me a private message on Discord, it
